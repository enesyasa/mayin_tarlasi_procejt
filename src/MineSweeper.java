...
public class MineSweeper {
    // Sınıfın özellikleri
    int rowNumber;              // Tahtanın satır sayısı
    int colNumber;              // Tahtanın sütun sayısı
    int mineNumber;             // Mayın sayısı
    String[][] answerBoard;     // Mayınların yerini saklayan tahta
    String[][] board;           // Kullanıcının gördüğü oyun tahtası
    int correctAnswer = 0;      // Doğru hücreleri bulma sayacı
    int row;                    // Kullanıcının seçtiği satır
    int column;                 // Kullanıcının seçtiği sütun
    int rowMaxLimit;            // Satırın maksimum sınırları
    int rowMinLimit;            // Satırın minimum sınırları
    int columnMaxLimit;         // Sütunun maksimum sınırları
    int columnMinLimit;         // Sütunun minimum sınırları
    int mineCount = 0;          // Seçilen hücrenin etrafındaki mayın sayısı
    ...
    // Oyun tahtasını "-" ile dolduran metot
    void fillArr() {
    ...
    // Mayınları rasgele tahtaya yerleştiren metot
    void placeMines() {
    ...
    // Mayınların konumunu ekrana yazdıran metot
    ...
    // Kullanıcının seçtiği hücrenin etrafındaki mayınları bulan metot
    void findMines() {
